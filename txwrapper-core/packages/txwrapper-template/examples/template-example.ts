...
async function main(): Promise<void> {
	...
	// const alice = keyring.addFromUri('spread sword village control response joke phrase share merit miss door canoe setup surge remind tiger increase sphere busy hand scrap diesel hair bomb', { name: 'mnemonic' }, 'ed25519');
	...
	const unsigned = methods.balances.transfer(
		{
			value: '100',
			dest: { id: '5CYrF4rWMEfb2PWZKLxXxiH4aB8vLPwsigUahG6AszvgbBbj' }, // spread..
		},
		{
